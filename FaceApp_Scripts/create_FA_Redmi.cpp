...
string DEVICE = "f2bdbec";
string RETURN = "adb -s f2bdbec shell input tap 80 140\nsleep 1\n";
string SWIPE_RET = "adb -s f2bdbec shell input swipe 200 1900 900 1900 80\nsleep 1\n";
string APPLY = "adb -s f2bdbec shell input tap 970 2150\nsleep 3\n";
string SAVE = "adb -s f2bdbec shell input tap 1020 140\nsleep 2\n";

vector<string> initImgs(){
    vector<string> imgs;
    string GALLARY = "adb -s f2bdbec shell input tap 160 2110\nsleep 1\nadb -s f2bdbec shell input tap 300 140\nsleep 1\nadb -s f2bdbec shell input tap 300 580\nsleep 1\n";
    string SWIPE_GAL = "adb -s f2bdbec shell input swipe 540 2000 540 500 650\nsleep 1\n";
    string IMG0 = "adb -s f2bdbec shell input tap 170 480\nsleep 7\n";
    string IMG1 = "adb -s f2bdbec shell input tap 540 480\nsleep 7\n";
    string IMG2 = "adb -s f2bdbec shell input tap 900 480\nsleep 7\n";
    string IMG3 = "adb -s f2bdbec shell input tap 170 850\nsleep 7\n";
    string IMG4 = "adb -s f2bdbec shell input tap 540 850\nsleep 7\n";
    string IMG5 = "adb -s f2bdbec shell input tap 900 850\nsleep 7\n";
    string IMG6 = "adb -s f2bdbec shell input tap 170 1210\nsleep 7\n";
    string IMG7 = "adb -s f2bdbec shell input tap 540 1210\nsleep 7\n";
    string IMG8 = "adb -s f2bdbec shell input tap 900 1210\nsleep 7\n";
    string IMG9 = "adb -s f2bdbec shell input tap 170 1580\nsleep 7\n";
    string IMG10 = "adb -s f2bdbec shell input tap 540 1580\nsleep 7\n";
    string IMG11 = "adb -s f2bdbec shell input tap 900 1580\nsleep 7\n";
    string IMG12 = "adb -s f2bdbec shell input tap 170 1940\nsleep 7\n";
    string IMG13 = "adb -s f2bdbec shell input tap 540 1940\nsleep 7\n";
    string IMG14 = "adb -s f2bdbec shell input tap 900 1940\nsleep 7\n";
...
vector<vector<string>> initOpns(){
    ...
    string OP1_ = "adb -s f2bdbec shell input tap 110 1930\nsleep 1\n";
    string OP2_ = "adb -s f2bdbec shell input tap 330 1930\nsleep 1\n";
    string OP3_ = "adb -s f2bdbec shell input tap 550 1930\nsleep 1\n";
    string OP4_ = "adb -s f2bdbec shell input tap 770 1930\nsleep 1\n";
    string OP5_ = "adb -s f2bdbec shell input tap 990 1930\nsleep 1\n";
    string OP6_ = "adb -s f2bdbec shell input swipe 800 1930 300 1930 180\nsleep 1\nadb -s f2bdbec shell input tap 320 1930\nsleep 1\n";
    string OP7_ = "adb -s f2bdbec shell input swipe 800 1930 300 1930 180\nsleep 1\nadb -s f2bdbec shell input tap 540 1930\nsleep 1\n";
    string OP8_ = "adb -s f2bdbec shell input swipe 800 1930 300 1930 180\nsleep 1\nadb -s f2bdbec shell input tap 760 1930\nsleep 1\n";

    string OP_0 = "adb -s f2bdbec shell input tap 130 1880\nsleep 3\n";
    string OP_1 = "adb -s f2bdbec shell input tap 390 1880\nsleep 3\n";
    string OP_2 = "adb -s f2bdbec shell input tap 650 1880\nsleep 3\n";
    string OP_3 = "adb -s f2bdbec shell input tap 910 1880\nsleep 3\n";
    string OP_4 = "adb -s f2bdbec shell input swipe 700 1880 570 1880 100\nsleep 1\nadb -s f2bdbec shell input tap 950 1880\nsleep 3\n";
    string OP_5 = "adb -s f2bdbec shell input swipe 700 1880 475 1880 100\nsleep 1\nadb -s f2bdbec shell input tap 950 1880\nsleep 3\n";
    string OP_6 = "adb -s f2bdbec shell input swipe 700 1880 290 1880 100\nsleep 1\nadb -s f2bdbec shell input tap 430 1880\nsleep 3\n";
    string OP_7 = "adb -s f2bdbec shell input swipe 700 1880 290 1880 100\nsleep 1\nadb -s f2bdbec shell input tap 690 1880\nsleep 3\n";
    string OP_8 = "adb -s f2bdbec shell input swipe 700 1880 290 1880 100\nsleep 1\nadb -s f2bdbec shell input tap 950 1880\nsleep 3\n";
